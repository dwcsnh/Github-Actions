...
/* 
* A higher-order function that adds invariant checks to aggregate root creation and modification functions
*/
const makeWithInvariants =
  <A extends AggregateRoot<any, any>>(invariantCheckFn: InvariantCheckFn<A>) =>
